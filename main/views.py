...
def send_lead_to_webhook(contact):
    """Push contact lead to x-opperp CRM webhook"""
    WEBHOOK_URL = "https://x-opperp.com/api/v1/v1/webhooks/website-lead/"
    API_TOKEN = "47399e08-7406-4426-836f-bfc81bc09ae8"
    ...
    try:
        ...
        print(f"Webhook success: {response.status_code} — {response.text[:200]}")
